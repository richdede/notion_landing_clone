...
const tabs = [
  {
    ...
    description: "Ask literally anything. WorkWave Will answer.",
    more: (
  ...
  text-5xl
        ...
        <p
          className="
            ...
            "
        >
          WorkWave is the connected workspace where better, faster work happens.
        </p>
          ...
          <Link href="/">
            <Button className="py-1 ">
              <div className="flex items-center justify-center">
                <div className="text-lg">Get WorkWave free</div>
                <div>
